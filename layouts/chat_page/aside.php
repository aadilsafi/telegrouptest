<div class="col-md-5 col-lg-3 aside page_column visible" column="first">
    <div class='head' style="background:#517da2; justify-content: space-between">
        <?php
        if (Registry::load('current_user')->logged_in) {
        ?>
            <span class='menu toggle_side_navigation'>
                <i class="iconic_menu text-white"></i>
        ...
        <span class="topsearch "><i class="bi bi-search text-white"></i></span>
    </div>
